...
#create a main module:
    ...
    #while loop that runs until number_of_guesses is less than 1 or letters_to_guess is greater than zero:
        #variable called guess = ask_for_next_letter() and turn it into lower case 
        
#if statement that checks if guess is in correct_letter_guessed or guess is in incorrect_letters_guessed:
    ...
    #add guess to corrct_letters_guessed
#else:
    #add guess to incorrect_letters_guessed
    #number_of_guesses goes down by one 
    
#variable called word_string = generate_word_strign(WORD, correct_letters_guessed)
#print statement that prints word string 
#print statement that prints how many guesses you have left

#if statement checks if numbers of guessed is greater than a value 
    #print congratulations you guessed the words
#else:
